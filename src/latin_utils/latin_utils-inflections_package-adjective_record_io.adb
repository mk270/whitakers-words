...
package body Adjective_Record_IO is
   ...
   procedure Put (File : in File_Type; Item : in Adjective_Record) is
   begin
   ...
   procedure Put (Item : in Adjective_Record) is
   begin
   ...
   begin
      ...
      Comparison_Type_IO.Get
         (Source (Low + 1 .. Source'Last), Target.Comparison, Last);
   end Get;
   ...
   begin
      ...
      Comparison_Type_IO.Put (Target (Low + 1 .. High), Item.Comparison);
